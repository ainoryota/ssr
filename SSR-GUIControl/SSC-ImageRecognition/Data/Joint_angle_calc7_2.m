...
function [F,the_2r,the_3r,the_1r,the_2f,the_3f,the_1f] ...
   = Joint_angle_calc7_2(x,the_xr,the_yr,the_zr,the_xf,the_yf,the_zf,phi_nr1,phi_nr2,the_nr,phi_nf1,phi_nf2,the_nf,...
    ...
    %OrCf=R("x",phi_nf1-phi_nr1)*R("z",the_nf-the_nr)*R("x",phi_nf2-phi_nr2)*OfCf;
    ...
    M_0f = Co_0f\R("x",phi_nf1-phi_nr1)*R("z",the_nf-the_nr)*R("x",phi_nf2-phi_nr2)*R("x",the_xf)*R("y",the_yf)*R("z",the_zf);
