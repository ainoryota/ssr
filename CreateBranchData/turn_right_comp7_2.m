...
%分岐後の姿勢角を分岐後のケーブル座標系で与えようとして失敗したもの
...
for t = 1:1000
    ...
    if switching == 0
        if flag == 0    %前輪の分岐開始
            ...
            [Ln1,OrCr,OfCf,OrOf,OrOw1r,OrOw2r,OfOw1f,OfOw2f] = node_cal1(the_xr,the_yr,the_zr,the_xf,the_yf,the_zf,phi_nr1,the_nr,phi_nr2,phi_nf1,the_nf,phi_nf2,Ln2,Lc,Rw,rw,d,mode);
        ...
        elseif flag == 1
            ...
            [Ln2,OrCr,OfCf,OrOf,OrOw1r,OrOw2r,OfOw1f,OfOw2f] = node_cal2(the_xr,the_yr,the_zr,the_xf,the_yf,the_zf,phi_nr1,the_nr,phi_nr2,phi_nf1,the_nf,phi_nf2,Ln1,Lc,Rw,rw,d,mode);
            if t2 == n_bra
                flag = 2;
                L_def = Ln1;
            end
    ...
    %収束計算
    fun = @(x)Joint_angle_calc7_2(x,the_xr,the_yr,the_zr,the_xf,the_yf,the_zf,phi_nr1,phi_nr2,the_nr,phi_nf1,phi_nf2,the_nf,...
    ...
    [F,the_2r,the_3r,the_1r,the_2f,the_3f,the_1f] ...
            = Joint_angle_calc7_2(x,the_xr,the_yr,the_zr,the_xf,the_yf,the_zf,phi_nr1,phi_nr2,the_nr,phi_nf1,phi_nf2,the_nf,...
                                gamma1,a1,a2,a3,Lc,OrCr,OfCf,OrOf,g0,g2,g3,g4,g6,w0,w2,w3,w4,w6,mode);
...
%%
%Ln2を与えて，Ln1を返す関数
function [Ln1,OrCr,OfCf,OrOf,OrOw1r,OrOw2r,OfOw1f,OfOw2f] = node_cal1(the_xr,the_yr,the_zr,the_xf,the_yf,the_zf,phi_nr1,the_nr,phi_nr2,phi_nf1,the_nf,phi_nf2,Ln2,Lc,Rw,rw,d,mode)
    if mode == 1 %右分岐モード
        %後輪
...
%     OrOf = Ln1*R1+Ln2*R2;
    ...
    R1 = R("x",phi_nr1)*R("z",the_nr)*R("x",phi_nr2);
    R2 = R("x",phi_nf1)*R("z",the_nf)*R("x",phi_nf2);
    
    R_OrCr = R1*OrCr;
    R_OfCf = R2*OfCf;
    
    a = R_OfCf(1)-R_OrCr(1); b = R_OfCf(2)-R_OrCr(2); c = R_OfCf(3)-R_OrCr(3);
    d = [1 0 0]*R1*[1;0;0]; e = [0 1 0]*R1*[1;0;0]; f = [0 0 1]*R1*[1;0;0];
    g = [1 0 0]*R2*[1;0;0]; h = [0 1 0]*R2*[1;0;0]; i = [0 0 1]*R2*[1;0;0];
    
    A = d^2+e^2+f^2; B = g^2+h^2+i^2; C = a^2+b^2+c^2;
    D = a*d+b*e+c*f; E = a*g+b*h+c*i; F = d*g+e*h+f*i;
...
function [Ln2,OrCr,OfCf,OrOf,OrOw1r,OrOw2r,OfOw1f,OfOw2f] = node_cal2(the_xr,the_yr,the_zr,the_xf,the_yf,the_zf,phi_nr1,the_nr,phi_nr2,phi_nf1,the_nf,phi_nf2,Ln1,Lc,Rw,rw,d,mode)
