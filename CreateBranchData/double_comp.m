%% 完成版
%スイッチング以外，modeを選ぶことはできる

%% 初期設定
%ケーブル条件
    gamma1 = 0*pi/180;      %ケーブル斜度
    phi_n =  0*pi/180;      %ケーブル平面の回転角
...
%分岐モード
    ...
    %(7)後輪テンション，前輪ノーマルから，両輪テンションモード
    %(8)前輪テンション，後輪輪ノーマルから，両輪テンションモード
    %(9)ノーマルモードで分岐
%データの保存
    save = 0;
    animation = 1;
